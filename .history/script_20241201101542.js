...
function takeCommand(message) {
    ...
    if (message.includes("hello") || message.includes("hey") || message.includes("Hello , asadullah") || message.includes("hey , asadullah")) {
        ...
        speak("I am a virtual assistant Fidu, created by Sir Asadullah Shafique.");
    } 
        ...
        let finalText = "This is what I found on the internet regarding " + message.replace("asadullah", "");
        speak(finalText);
        window.open(`https://www.google.com/search?q=${message.replace("asadullah", "")}`, "_blank");
    }
}